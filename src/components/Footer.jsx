...
export default function Footer() {
  return (
    <footer className="bg-secondary text-white py-4 sm:py-6 mt-4 sm:mt-10 border-t border-white/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-6 text-[11px] sm:text-sm leading-tight">
        <div>
          <h4 className="font-semibold text-accent text-[12px] sm:text-base mb-1.5 sm:mb-3">CineVerse</h4>
          <p className="hidden sm:block text-white/80">Modern movie browsing. Built with React + Tailwind.</p>
          <p className="mt-1 sm:mt-3 text-[10px] sm:text-xs text-white/60">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mt-2 sm:mt-6">
